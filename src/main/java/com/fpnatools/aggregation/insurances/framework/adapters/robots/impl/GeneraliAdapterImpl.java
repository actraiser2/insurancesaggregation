...
@Scope("prototype")
public class GeneraliAdapterImpl implements RobotAdapter {

	private String baseUrl;
	private String sessionToken;
	private JsonPath globalPositionJsonPath;
	private HomeDTO titularHome;
	...
	public List<HomeInsuranceDTO> getHomeInsurances() {
		...
		insuranceList.stream().
			...
			forEach(i -> {
				...
				List<CoverageDTO> coverages = coverageList.stream().
				...
				var insurancedContent = new CoverageDTO();
