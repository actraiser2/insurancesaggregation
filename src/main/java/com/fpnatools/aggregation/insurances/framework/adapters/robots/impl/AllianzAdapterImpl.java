...
@Scope("prototype")
public class AllianzAdapterImpl implements RobotAdapter {

	private static Logger logger = LoggerFactory.getLogger(AllianzAdapterImpl.class);
		...
		if (insuranceList != null) {
			...
			forEach(i -> {
				...
				try {
					...
					List<CoverageDTO> coverages = Observable.fromArray(linesPdf).
